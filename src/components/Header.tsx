...
export function Header({ onNewInspection, onOpenProfile, onOpenSettings, onOpenHelp }: { onNewInspection: () => void; onOpenProfile: () => void; onOpenSettings: () => void; onOpenHelp: () => void }) {
  ...
  return (
    <header className="hdr">
      ...
      <div className="hdr-r">
        ...
        <button className="profile-btn" onClick={onOpenHelp} title="User guide & help">
